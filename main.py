...
class OptionsEditor(QMainWindow):
    ...
    def create_help_texts(self):
        self.help_texts = {
            ...
            "DetectedFrequencyGHz": "The detected total CPU power, based on CPU type, count, and speed. Do not modify manually.",
            "DetectedMemoryAmountMB": "The amount of physical memory detected in your system. Do not modify manually.",
            "LastUsedGPU": "The GPU that was last used to run the game. Do not modify manually.",
            "GPUDriverVersion": "The version of the GPU driver last detected. Do not modify manually.",
            "DisplayDriverVersion": "The version of the display driver used to run the game. Do not modify manually.",
            "DisplayDriverVersionRecommended": "The recommended display driver version as of the last game startup. Do not modify manually.",
