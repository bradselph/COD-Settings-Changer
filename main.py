...
class OptionsEditor(QMainWindow):
	...
	def log(self, message):
		if hasattr(self, 'log_window'):
			...
			print(message)  # Fallback to print if log_window is not available
	...
	def create_help_texts(self):
		self.help_texts = {
			...
			"DisableHWChangeDetection": "Disables automatic detection of hardware changes. May be useful if you frequently change hardware components.",
			"AudioWantedChannelsNumber": "Sets the number of audio output channels. Valid values are 2, 4, 6, 8, 16. Zero uses system default.",
			"CinematicVolume": "Adjusts the volume of audio during cinematic sequences.",
			"MuteAudioWhileOutOfFocus": "Mutes game audio when the window is not in focus.",
			"LicensedMusicVolume": "Adjusts the volume of licensed music in the game.",
			"WarTracksVolume": "Adjusts the volume of war tracks in the game.",
			"TelescopeVolume": "Adjusts the volume of audio in the Telescope (Message of the Day) feature.",
			"MicInactivityMuteDelay": "Sets the delay (in seconds) before muting the microphone due to inactivity. Set to -1 to disable.",
			"MicRecLevel": "Adjusts the recording level of your microphone.",
			"MicThresholdAggressive": "Sets an aggressive threshold for microphone activation. Used in conjunction with voice_mic_threshold.",
			"MicThresholdLoud": "Sets the threshold for detecting loud talking. Used in conjunction with voice_mic_threshold.",
			"MicAggressiveInTime": "Sets the duration of continuous talk time before switching to aggressive voice threshold.",
			"MicAggressiveOutTime": "Sets the duration of continuous mute time before switching back to normal voice threshold.",
			"MicPostLoudAggressiveTime": "Sets the duration to use aggressive threshold after detecting loud talking to prevent audio feedback.",
			"WindowsSonicEnable": "Enables Microsoft's Windows Sonic 3D audio spatializer. When disabled, presents a standard 7.1 mix.",
			"MicNormalTimeOut": "Sets the duration of silence before cutting the microphone after normal talking.",
			"MicLoudTimeOut": "Sets the duration of silence before cutting the microphone after loud talking.",
			"CorpseLimit": "Sets the maximum number of AI corpses that can appear in the game.",
			"BloodLimit": "Enables limiting of blood effects to prevent excessive accumulation.",
			"BloodLimitInterval": "Sets the interval (in milliseconds) between blood effects when blood limiting is enabled.",
			"MarksEntsPlayerOnly": "When enabled, only the player's bullets will leave marks on entities.",
			"InvalidCmdHintDuration": "Sets the duration (in milliseconds) for which invalid command hints are displayed.",
			"InvalidCmdHintBlinkInterval": "Sets the blink rate (in milliseconds) for invalid command hints.",
			"MapLocationSelectionCursorSpeed": "Adjusts the speed of the cursor when selecting locations on the map using a gamepad.",
			"MapLocationSelectionCursorSpeedMouse": "Adjusts the speed of the cursor when selecting locations on the map using a mouse.",
			"PreferredDisplayMode": "Sets the preferred display mode (fullscreen, borderless, etc.) for the game.",
			"WindowX": "Sets the X-coordinate of the game window when in windowed mode.",
			"WindowY": "Sets the Y-coordinate of the game window when in windowed mode.",
			"WindowWidth": "Sets the width of the game window when in windowed mode.",
			"WindowHeight": "Sets the height of the game window when in windowed mode.",
			"WindowMaximized": "When enabled, the game window will start maximized.",
			"VSync": "Synchronizes the game's frame rate with your monitor's refresh rate to prevent screen tearing.",
			"DisplayGamma": "Sets the color space for monitor output. Affects how colors are displayed.",
			"BulletImpacts": "Toggles the visibility of bullet impact effects.",
			"ModelQuality": "Adjusts the quality of 3D models in the game. Higher quality may impact performance.",
			"CorpsesCullingThreshold": "Sets the threshold for culling (removing) corpses from the scene to improve performance.",
			"SubdivisionLevel": "Adjusts the level of Catmull-Clark subdivision for smoother surfaces. Higher levels may impact performance.",
			"UiQuality": "Sets the quality of the user interface elements.",
			"WorldStreamingQuality": "Adjusts the quality of world streaming. Higher quality may require more system resources.",
			"DynamicSceneResolution": "Enables dynamic adjustment of scene resolution to maintain performance.",
			"DynamicSceneResolutionTarget": "Sets the target frame time (in milliseconds) for dynamic scene resolution adjustments.",
			"AbsoluteTargetResolution": "Sets a fixed target resolution for the game.",
			"ScreenSpaceShadowQuality": "Adjusts the quality of screen space shadows. Higher quality may impact performance.",
			"SunShadowCascade": "Sets the quality of distant sun shadows. Higher quality uses more shadow cascades but impacts performance.",
			"ShadowQuality": "Adjusts the overall quality of shadows in the game.",
			"SSRMode": "Sets the mode for Screen Space Reflections. Higher quality modes may impact performance.",
			"AATechniquePreferred": "Sets the preferred anti-aliasing technique to reduce jagged edges.",
			"ReflectionProbeRelighting": "Adjusts the number of stages for reflection probe relighting. More stages improve quality but impact performance.",
			"StaticSunshadowClipmapResolution": "Sets the resolution for static sun shadow clipmaps. Higher resolutions improve shadow quality but impact performance.",
			"XeSSQuality": "Adjusts the quality setting for Intel XeSS (Xe Super Sampling) upscaling technology.",
			"AMDSuperResolutionQuality": "Sets the quality level for AMD FidelityFX Super Resolution upscaling.",
			"AMDContrastAdaptiveSharpeningStrength": "Adjusts the strength of AMD's Contrast Adaptive Sharpening (CAS) filter.",
			"AMDSuperResolution2Quality": "Sets the quality level for AMD FidelityFX Super Resolution 2 and 3 upscaling.",
			"NVIDIAImageScaling": "Enables NVIDIA Image Scaling for improved performance and image quality on supported GPUs.",
			"NVIDIAImageScalingQuality": "Adjusts the quality setting for NVIDIA Image Scaling.",
			"NVIDIAImageScalingSharpness": "Sets the sharpness level for NVIDIA Image Scaling.",
			"VRS": "Enables Variable Rate Shading to improve performance by reducing shading rate in less noticeable areas.",
			"PersistentDamageLayer": "Enables a persistent layer for damage effects, potentially improving performance in scenes with lots of destruction.",
			"STLodSkip": "Sets the number of Shadow Tree Levels of Detail to skip, potentially improving performance at the cost of shadow quality.",
			"WaterCausticsMode": "Adjusts the quality of water caustics effects. Higher quality may impact performance.",
			"WaterWaveWetness": "Enables persistent wetness effects on static geometry from water waves.",
			"ReflectionProbeHalfResolution": "Enables half-resolution reflection probes to improve performance at the cost of reflection quality.",
			"VirtualTexturingMemoryMode": "Sets the memory mode for virtual texturing. Larger modes provide better texture quality but require more VRAM.",
			"WeatherGridVolumesQuality": "Adjusts the quality of volumetric weather effects. Higher quality may impact performance.",
			"DxrMode": "Enables DirectX Raytracing for improved lighting, shadows, and reflections on supported hardware.",
			"EnableVelocityBasedBlur": "Enables radial motion blur based on player velocity for a more dynamic visual effect.",
			"SustainabilityPauseRendering": "Pauses rendering in multiplayer when in the pause menu or out of focus to save power.",
			"SustainabilityMenuSceneResolution": "Reduces the dynamic scene resolution in non-interactive scenes to save power.",
			"SkipIntro": "Skips the introduction movie that plays when the game is started.",
			"ViewedSplashScreen": "Allows the player to skip the splash screen if it has been viewed at least once.",
			"UseOSCursors": "Uses the operating system cursors instead of the custom game cursor for accessibility reasons.",
			"ShowFPSCounter": "Displays an on-screen FPS (Frames Per Second) counter.",
			"SkipSeasonVideo": "Controls whether the season video is shown when the player logs in for the second time after seeing it once.",
			"SkipSeasonIntroVideo": "Controls whether the season intro video plays at all.",
			"WeaponCycleDelay": "Sets the minimum delay (in milliseconds) between valid mouse wheel inputs for weapon cycling.",
			"MouseUsesRawInput": "Enables raw input for the mouse, potentially improving responsiveness and accuracy.",
			"YawSpeed": "Sets the maximum yaw (horizontal rotation) speed in degrees for gamepad and keyboard.",
			"PitchSpeed": "Sets the maximum pitch (vertical rotation) speed in degrees for gamepad.",
			"VehicleMouseSteerSensitivity": "Adjusts the sensitivity of mouse steering for vehicles.",
			"GamepadMenuScrollDelayFirst": "Sets the initial delay (in milliseconds) for menu scrolling with a gamepad.",
			"GamepadMenuScrollDelayRestStart": "Sets the starting delay (in milliseconds) for subsequent menu scrolls with a gamepad.",
			"GamepadMenuScrollDelayRestEnd": "Sets the ending delay (in milliseconds) for subsequent menu scrolls with a gamepad.",
			"GamepadMenuScrollDelayRestAccel": "Sets the acceleration (in milliseconds per repeat) for menu scrolling with a gamepad."
	}
